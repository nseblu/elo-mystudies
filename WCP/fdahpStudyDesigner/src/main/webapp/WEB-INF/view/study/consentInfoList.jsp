...
<form:form action="/studybuilder/adminStudies/consentInfo.do?_S=${param._S}" name="consentInfoForm"
           id="consentInfoForm"
           method="post">
...
<form:form action="/studybuilder/adminStudies/consentMarkAsCompleted.do?_S=${param._S}"
