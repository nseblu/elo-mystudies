...
<div class="col-sm-10 col-rc white-bg p-none">
  <form:form
    ...
    <div class="right-content-body">
      ...
      <div class="form-group mr-sm" style="white-space: normal; margin-top: -9px;">For studies that are live, notifications get published for scheduled delivery to participants as soon as you mark the Notifications section complete.</div>
